...
func StarterTemplates(now time.Time) []StarterTemplate {
	...
	return []StarterTemplate{
		{Key: "insurance-certificate", Name: "Insurance Certificate", Description: "Track business liability or cyber insurance renewal.", Item: Item{Title: "Insurance Certificate", Category: "Compliance", Status: "expiring", ReminderDaysBefore: 30, ExpiryDate: &expSoon, OwnerName: "Finance Owner", OwnerEmail: "finance@example.com", Notes: "Starter template for insurance evidence."}},
		{Key: "privacy-policy", Name: "Privacy Policy", Description: "Maintain current policy publication and review ownership.", Item: Item{Title: "Privacy Policy", Category: "Legal", Status: "active", ReminderDaysBefore: 30, ExpiryDate: &expLong, OwnerName: "Legal Owner", OwnerEmail: "legal@example.com", Notes: "Starter template for policy evidence."}},
		{Key: "vendor-agreement", Name: "Vendor Agreement", Description: "Track critical supplier contracts and renewal windows.", Item: Item{Title: "Vendor Agreement", Category: "Legal", Status: "active", ReminderDaysBefore: 45, ExpiryDate: &expLong, OwnerName: "Operations Owner", OwnerEmail: "ops@example.com", Notes: "Starter template for vendor agreement evidence."}},
		{Key: "soc2-evidence", Name: "SOC2 Evidence", Description: "Store and refresh SOC2 related policy or control artifacts.", Item: Item{Title: "SOC2 Evidence", Category: "Security", Status: "active", ReminderDaysBefore: 30, ExpiryDate: &expSoon, OwnerName: "Security Owner", OwnerEmail: "security@example.com", Notes: "Starter template for SOC2 evidence."}},
		{Key: "accessibility-statement", Name: "Accessibility Statement", Description: "Track statement updates and publication evidence.", Item: Item{Title: "Accessibility Statement", Category: "Compliance", Status: "active", ReminderDaysBefore: 30, ExpiryDate: &expLong, OwnerName: "Product Owner", OwnerEmail: "product@example.com", Notes: "Starter template for accessibility statement evidence."}},
		{Key: "employee-handbook-ack", Name: "Employee Handbook Acknowledgement", Description: "Record annual handbook acknowledgment collection.", Item: Item{Title: "Employee Handbook Acknowledgement", Category: "HR", Status: "expiring", ReminderDaysBefore: 30, ExpiryDate: &expSoon, OwnerName: "People Ops", OwnerEmail: "people@example.com", Notes: "Starter template for handbook acknowledgment evidence."}},
	}
}
